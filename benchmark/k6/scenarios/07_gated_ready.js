/**
 * Scenario 7: Gated Route, READY — the memo-hot gate cost
 *
 ...
 * handler, no gate).
 *
 * Usage: TARGET_HOST=localhost:8085 k6 run benchmark/k6/scenarios/07_gated_ready.js
 */
...
export default function () {
    const res = http.get(`${BASE}/gr/ping`);
...
export function handleSummary(data) {
    ...
    return {
        [`benchmark/results/07_gated_ready_${ts}.json`]: JSON.stringify(data, null, 2),
