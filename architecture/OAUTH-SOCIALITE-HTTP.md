...
> **EXECUTION COMPLETE 2026-09:** S0 `1d3b8cd` · S1 `8b79947`/`f8e2459`/`177b935`/`0ffae09` · S2 `c9c036c` ·
> S3 `a3b970e` · S5 `56b49d6` — the authorised scope (S0–S3 + S5) is fully shipped, each milestone its own commit
> with gates green throughout (suite 5,365 → 5,441, +76 tests; RZ-015 held: the phar gained zero dependencies).
> S4 (OAuth 1.0a) stays deferred per §8's own rule — still no named provider.
