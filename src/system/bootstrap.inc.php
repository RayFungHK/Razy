...
\define('RAZY_VERSION', '1.1.0-beta.2');
...
if (\php_sapi_name() === 'cli' || \defined('STDIN')) {
    ...
    // Session cookie path — scope cookies to subdirectory installs (e.g. /abc).
    \define('RELATIVE_COOKIE_PATH', RELATIVE_ROOT !== '' ? RELATIVE_ROOT : '/');
