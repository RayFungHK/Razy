...
class Pilot
{
     ...
     * @throws Throwable
     */
    public function addAPI(mixed $command, ?string $path = null): self
    {
        if (is_array($command)) {
     ...
     * @throws Error
     */
    public function bind(mixed $method, ?string $path = null): Pilot
    {
        if (is_array($method)) {
     ...
     * @throws Throwable
     */
    public function listen(mixed $event, ?string $path = null): self
    {
        if (is_array($event)) {
