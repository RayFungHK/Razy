...
class Mailer
{
	...
	/**
	 * The storage of the attachments
	 * @var array
	 */
	private array $attachments = [];
	/**
	 * The storage of the blind carbon copy recipients
	 * @var array
	 */
	private array $blindCarbonCopy = [];
	/**
	 * The storage of the carbon copy recipients
	 * @var array
	 */
	private array $carbonCopy = [];
	/**
	 * The string of the default charset
	 * @var string
	 */
	 ...
	 * @var string
	 */
	private string $protocol = 'tls12';
	/**
	 * The storage of the recipient
	 * @var array
	 */
	private array $recipient = [];
	/**
	 * The storage of the `Reply-To`
	 * @var array
	 */
	...
	private $socket = null;
	/**
	 * The string of the subject
	 * @var string
	 */
	private string $subject = '';
	/**
	 * The string of the text message body
	 * @var string
	 */
	 ...
	 * @param string $origin
	 */
	public function __construct(private readonly string $hostname, private readonly int $port = 25, private readonly int $connectionTimeout = 30, private readonly int $responseTimeout = 5, private string $origin = '')
	{
	...
	{
		$message = null;
		$this->socket = fsockopen($this->hostname, $this->port, $errno, $error, $this->connectionTimeout);
