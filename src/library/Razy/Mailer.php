...
class Mailer
{
     ...
     * @param string $origin
     */
    public function __construct(string $hostname, int $port = 25, int $connectionTimeout = 30, int $responseTimeout = 5, string $origin = '')
    {
        $this->port              = $port;
        $this->hostname          = $hostname;
        $this->connectionTimeout = $connectionTimeout;
        $this->responseTimeout   = $responseTimeout;
        $this->origin            = (empty($origin)) ? gethostname() : $origin;
