...
class Profiler
{
    ...
    private function createSample(): array
    {
        ...
        return [
            ...
            'defined_functions_count' => \count($defined_functions['user']),  // Count of user-defined functions
            'declared_classes_count' => \count(\get_declared_classes()),       // Count of all declared classes
        ];
    }
}
