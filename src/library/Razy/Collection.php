...
class Collection extends ArrayObject
{
	...
	/**
	 * Implement __serialize to support the serialize() function.
	 *
	 * @return array
	 */
	 ...
	 * * Cannot provides type hinting of the parameter due to the ArrayObject::__unserialize($serialized) cannot be
	 * override.
	 *
	 * @param array $data
	 */
