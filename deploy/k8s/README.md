...
docker build -f deploy/Dockerfile.worker -t registry.example.com/razy/worker:1.1.0-beta.1 .
docker push registry.example.com/razy/worker:1.1.0-beta.1
...
```json
{"status":"ok","uptime_seconds":42,"timestamp":1760000000,"version":"1.1.0-beta.1","php":"8.3.x","mode":"worker"}
```
